...
export default function ChatPage() {
  ...
  const newChatModelGridClassName = models.length >= 3 ? "grid gap-3 sm:grid-cols-2 xl:grid-cols-3" : models.length === 2 ? "grid gap-3 sm:grid-cols-2" : "grid max-w-xl gap-3";
